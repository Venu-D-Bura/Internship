					...
					<?php
						...
						if(mysqli_num_rows($res)>0){
							...
							while($i=mysqli_fetch_array($res))
							{
								...
								<button class='update_delete'><a class='anchor' href='UpdateAlbumType.php?a=$i[0] '>Update</a></button>
								<button class='update_delete'><a class='anchor' href='DeleteAlbumType.php?a=$i[0]'>Delete</a></button>
								</td>
								</tr>";
							}
						}
