...
<body>
	...
	<div class="main">
			...
			<table cellpadding=10px>
					...
					<?php
						...
						if(mysqli_num_rows($res)>0){
							echo "<tr ><th>Page Quality</th><th>Price Per Page</th></tr>";
		...
		<button class='insert'><a href='AddPageQuality.php' class='anchor_insert'>ADD</a></button>
		<button class='insert'><a href='DisplayPageQuality1.php' class='anchor_insert'>DISPLAY</a></button>
