...
<body>
	...
	<div class="main">
			...
			<table cellpadding=10px>
					...
					<?php
						...
						if(mysqli_num_rows($res)>0){
							echo "<tr ><th>Album Type Names</th><th>Price</th></tr>";						
		...
		<button class='insert'><a href='AddAlbumType.php' class='anchor_insert'>ADD</a></button>
		<button class='insert'><a href='DisplayAlbumType1.php' class='anchor_insert'>DISPLAY</a></button>
